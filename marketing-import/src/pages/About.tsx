  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-toro-dark text-toro-light">
        {/* Make Nav transparent so the toro-dark shows behind it */}
        ...
        <section className="py-32 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              At Toro Marketing, we don't believe in quick wins or
              one‑size‑fits‑all solutions. We believe in long‑term growth,
              strong partnerships, and strategies that work, over and over
              again. Whether you're scaling your brand, growing your
              audience, or expanding your team, we're here to help you do it
      ...
      {/* Company Story – back to light theme */}
      <section className="py-16 px-4 bg-toro-light text-toro-dark">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            <Card className="border-toro-gold/20 mb-12">
              <CardHeader>
                <CardTitle className="text-3xl text-toro-gold text-center">
                  Our Strategy, Your Success
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-toro-grey leading-relaxed">
                  Toro Marketing offers full-scale video content creation,
                  digital platform management, targeted social media
                  campaigns, and recruiting services designed to help
                  businesses grow their brand, increase revenue, and build
                  reliable partners. This proposal outlines our services,
                  pricing, and how we help you create consistent sales
      ...
      {/* Six-Phase Success Model – still light */}
